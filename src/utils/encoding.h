...
inline auto get_u16(const Byte *in) noexcept -> uint16_t
{
    const auto src = reinterpret_cast<const uint8_t*>(in);
    return static_cast<uint16_t>(src[1] | (src[0] << 8));
}

inline auto get_u16(BytesView in) noexcept -> uint16_t
{
    return get_u16(in.data());
}

inline auto get_u32(const Byte *in) noexcept -> uint32_t
{
    const auto src = reinterpret_cast<const uint8_t *>(in);
...
inline auto get_u32(BytesView in) noexcept -> uint32_t
{
    return get_u32(in.data());
}

inline auto get_u64(const Byte *in) noexcept -> uint64_t
{
    const auto src = reinterpret_cast<const uint8_t *>(in);
...
inline auto get_u64(BytesView in) noexcept -> uint64_t
{
    return get_u64(in.data());
}

inline auto put_u16(Byte * out, uint16_t value) noexcept -> void
{
...
inline auto put_u16(Bytes out, uint16_t value) noexcept -> void
{
    put_u16(out.data(), value);
}

inline auto put_u32(Byte *out, uint32_t value) noexcept -> void
{
    auto *dst = reinterpret_cast<uint8_t *>(out);
...
inline auto put_u32(Bytes out, uint32_t value) noexcept -> void
{
    put_u32(out.data(), value);
}

inline auto put_u64(Byte *out, uint64_t value) noexcept -> void
{
    auto *dst = reinterpret_cast<uint8_t *>(out);
...
inline auto put_u64(Bytes out, uint64_t value) noexcept -> void
{
