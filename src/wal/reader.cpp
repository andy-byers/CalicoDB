...
//            CALICO_TRY_CREATE(not_eof, read_block(position.block_id));
...
//            CALICO_TRY(record.merge(*maybe_partial));
...
//}
//
//auto WALReader::read_block(Size block_id) -> Result<bool>
//{
...
//}
//
//auto WALReader::read_record(Size offset) -> Result<WALRecord>
//{
...
//    if (record.has_value()) {
//        CALICO_EXPECT_GE(record->size(), WALRecord::MINIMUM_SIZE);
