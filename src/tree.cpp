...
[[nodiscard]] auto merge_root(Node &root, Node &child)
{
...
constexpr uint32_t kLinkContentSize = kPageSize - kLinkContentOffset;
...
auto vacuum_end_page(uint32_t db_size, uint32_t free_size) -> Id
{
