...
{
    put_u64(page.data(page_offset(page) + kPageHeaderSize), next_id.value);
}
...
auto Tree::vacuum_step(Page &free, TableSet &tables, Id last_id) -> Status
{
    ...
    std::memcpy(free.data(sizeof(Lsn)),
