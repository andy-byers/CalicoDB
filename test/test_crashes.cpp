...
//    }
//
//    auto run_transaction_test(DropType loss_type, bool reopen_after_failure)
//    {
//        m_env.m_drop_file = "";
//        reopen_db(true);
//
...
//        const auto drop_param = create_drop_param(m_filename + kDefaultWalSuffix, loss_type);
//
...
//    }
//
//    auto run_checkpoint_test(DropType loss_type, bool reopen_after_failure)
//    {
//        m_env.m_drop_file = "";
//        reopen_db(true);
//
...
//        ASSERT_OK(perform_checkpoint({}, true));
//
//        const auto drop_param = create_drop_param(m_filename, loss_type);
//
//        ASSERT_OK(perform_writes({}, kNumWrites, 1));
...
//    {
//        for (DropType loss_type = kDropAll;
//             loss_type < kDropTypeCount;
//             loss_type = static_cast<DropType>(loss_type + 1)) {
//            (this->*cb)(loss_type, false);
//            (this->*cb)(loss_type, true);
//        }
//    }
//};
//
