...
//     [[nodiscard]] auto new_log_writer(const std::string &filename, LogWriter *&out) -> Status override;
//
...
// };
//
// class DataLossEditor : public File
//{
...
//
// public:
//     explicit DataLossEditor(std::string filename, File &file, DataLossEnv &env)
...
// };
//
// class DataLossLogger : public LogWriter
//{
//     std::string m_filename;
//     DataLossEnv *m_env = nullptr;
//     LogWriter *m_file = nullptr;
//
// public:
//     explicit DataLossLogger(std::string filename, LogWriter &file, DataLossEnv &env)
//         : m_filename {std::move(filename)},
//           m_env {&env},
//           m_file {&file}
//     {
...
// }
//
// auto DataLossEnv::new_log_writer(const std::string &filename, LogWriter *&out) -> Status
//{
//     EXPECT_OK(target()->new_log_writer(filename, out));
